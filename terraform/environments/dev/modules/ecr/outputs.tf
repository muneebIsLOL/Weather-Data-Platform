...
output "backend_image" {
  value = "${data.aws_ecr_image.backend.image_uri}@${data.aws_ecr_image.backend.id}"
}
...
output "frontend_image" {
  value = "${data.aws_ecr_image.frontend.image_uri}@${data.aws_ecr_image.frontend.id}"
}
...
output "orchestrator_image" {
  value = "${data.aws_ecr_image.orchestrator.image_uri}@${data.aws_ecr_image.orchestrator.id}"
}
